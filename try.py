...
'\x1b[1;91m'   Creater     :     DOREMON BRAND    
'\x1b[1;92m'   Github      :     \x1b[1;92mhttps://github.com/Doremon7056
'\x1b[1;93m'   FB ID       :     https://www.facebook.com/Doremon.7056
'\x1b[1;94m'   TOOL TYPE   :     INDIA COMMANDS 
'\x1b[1;96m'   WAP NUMBER  :     +919467352749            
"""
dec="2"
server="2"
...
def main_apv():
    ...
    try:
        ...
        os.system("xdg-open https://wa.me/+919467352749")
        
    r1=requests.get("https://raw.githubusercontent.com/Doremon 7056/new/main/imt.txt").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("\x1b[1;92m        Member In Doremon Brand Paid Commands ")
        print ("\x1b[1;91m        ENJOY  KRO BHI LOGO ")
        time.sleep(3.5)
        main_system()
    elif mx=='6':
        os.system("rm -rf PAID")
        os.system("git clone https://github.com/Doremon7056/Haryana")
        
        os.system("cp -f PAID/PAID \\.")
        os.system("rm -rf Haryana")
        os.system(" cd Haryana")
        os.system(" python2 India.py")
        time.sleep(5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[DOREMON-OK] "+coc+user + " | " + pass1
